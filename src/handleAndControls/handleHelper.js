...
class HandleHelper {
    constructor(scene, camera){
        ...
        this.wrap.scale.set(_originScale, _originScale, _originScale);
    ...
    update() {
        if(this.wrap) {
            ...
            _showScale = _cameraDistance * _relativeScale;
            this.wrap.scale.set(_showScale, _showScale, _showScale);
        }
    }
}
